...
scenario = """
You are speaking with a nurse who will ask your visit to the hospital. 
Stay in character as John Doe and respond as you naturally would.
"""
...
Your personality is as follows: ```{persona}```
Your inital treatment is in-effective and you want came to the hosipital to ask for a new treatment and tell side effects of initial treatment given.
Scenario: ```{scenario}```
"""

messages = [
  {"role": "system", "content": prompt_follow_up},
  ]
